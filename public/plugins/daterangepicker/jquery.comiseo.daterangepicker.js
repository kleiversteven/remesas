	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				...
				{text: 'Ultimos 7 dias', dateStart: function() { return moment().subtract('days', 6) }, dateEnd: function() { return moment() } },
				{text: 'Ultima semana', dateStart: function() { return moment().subtract('days', 7).isoWeekday(1) }, dateEnd: function() { return moment().subtract('days', 7).isoWeekday(7) } },
			...
			initialText: 'Seleccione rango de fechas...', // placeholder text - shown when nothing is selected
			icon: 'ui-icon-triangle-1-s',
			applyButtonText: 'Aplicar', // use '' to get rid of the button
			clearButtonText: 'Borrar', // use '' to get rid of the button
			cancelButtonText: 'Cancelar', // use '' to get rid of the button
