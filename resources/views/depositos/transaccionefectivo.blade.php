                ...
                <div class="col-md-6" ><span class=" col-md-2"><b>Estatus: </b></span>
                   ...
                   @if($deposito[0]->estatus == 1)
                    ...
                    <span class="botones col-md-4">
                        <b class="fa fa-pencil" style="cursor: pointer;" onclick="estatus('{{ $deposito[0]->codeefec }}','{{ $deposito[0]->estatus }}')"></b>
                    </span>
...
@section('scripts')
    ...
    function estatus(idtrans,estatus){
        ...
        if(estatus ==  1){ select+= 'selected'; }  
            select+='>Transaccion sin validar</option>';
    ...
    function guardar(idtrans){
        ...
        var html = '';
        $.get("{{ url('modtransaccionefec') }}",'transac='+idtrans+'&estatus='+estatus,function(response){
             if(estatus ==  3){
...
function notificar(code){
    $.get("{{ url('notificacionefec') }}",'code='+code,function(response){
