...
<body>
    ...
    <fieldset>
        ...
        <table>
            <tr>
                <td colspan="4">
                    El repote a continuacion muestra el total de transaciones generadas desde {{ $desde }} hasta {{ $hasta }} por los usuarios tipo {{ $rol }},
            ...
            <tr>
             ...
             @foreach($depositos as $d)
                <tr>
                    ...
                    <td class="center">{{ $d->referencia_into }}</td>
